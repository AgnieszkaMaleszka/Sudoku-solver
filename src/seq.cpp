...
// -------------------------
// Klasa Grafu (reprezentacja Sudoku jako grafu)
// -------------------------
class Graph {
public:
    int size;
...
// -------------------------
// Klasa Osobnika (indywidualne rozwiązanie)
// -------------------------
class Individual {
public:
    vector<int> colors;
...
public:
    ...
    Individual run() {
        ...
        for (auto& indiv : population) {
            indiv.initialize(graph, rng);
            indiv.evaluate(graph);
        }
        ...
        while (generation < maxGenerations) {
            ...
            while (newPopulation.size() < populationSize) {
                ...
                Individual child = Individual::crossover(parent1, parent2, graph, rng);
                child.mutate(graph, rng, mutationRate);
